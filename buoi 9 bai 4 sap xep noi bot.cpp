...
for(int  i =0;i<n-1;i++){
	...
	//trong lan lap thu 2 cua vong lap thu 2 ta duyet tu 0 den n-i-1
	
	for(int j =0;j<n-i-1;j++) //duyet den phan tu dung sau phan tu cuoi cung ma phan tu cuoi cung dung sau phan tu da duoc duyet
	{
